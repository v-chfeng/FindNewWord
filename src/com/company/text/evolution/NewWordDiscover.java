package com.company.text.evolution;

import com.company.common.TextUtils;
import com.company.text.dic.CnDictionary;
import com.company.text.index.CnPreviewTextIndexer;
import com.company.text.index.TextIndexer;
import com.company.text.selector.CnTextSelector;
import com.company.text.selector.TextSelector;
...
public class NewWordDiscover {
	...
	private final static int MAX_CANDIDATE_LEN = 8;
